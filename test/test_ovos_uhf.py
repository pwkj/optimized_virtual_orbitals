"""
Test OVOS optimization on a simple molecules using UHF orbitals as the initial guess.
...
def test_ovos_uhf_CO():
    ...
    mo_coeffs = [mf.mo_coeff[0], mf.mo_coeff[1]]
